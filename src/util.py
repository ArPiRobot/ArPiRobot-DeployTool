...
class SettingsManager:
    ...
    def robot_user(self) -> str:
        return str(self.__settings.value(self.__ROBOT_USER_KEY, self.__DEFAULT_USER))
    ...
    def last_proj_folder(self) -> str:
        return str(self.__settings.value(self.__LAST_PROJ_FOLDER_KEY, self.__DEFAULT_PROJ_FOLDER))
